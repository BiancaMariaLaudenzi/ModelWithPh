 ...
 * Modified by Bianca Maria Laudenzi, Caterina Dalmano, Lucas Omar Muller on 31/12/2024
 * Based on the original version licensed under LGPL v2.1
 * 
 * This file is licensed under the GNU LGPL v2.1.
 * See COPYING.LGPL or https://www.gnu.org/licenses/old-licenses/lgpl-2.1.html
 * 
 * The original version can be found at https://sourceforge.net/projects/getpot/
 */
    ...
    // 0        no argument matches the starting string.
{
    ...
    if( ! search_loop_f ) return int(false);
